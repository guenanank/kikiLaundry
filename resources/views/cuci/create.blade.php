@extends('layout') @section('title', 'Cuci - Tambah Baru') @section('content')
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col-sm-6">
				<h2>Tambah Cuci Baru <small>Master data cuci.</small></h2>
			</div>
			<div class="col-sm-6">
	...
	<div class="card-body card-padding">
		{{ Form::open(['route' => 'cuci.store', 'class' => 'ajax_form'])}}
