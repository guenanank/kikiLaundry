...
<head>
	...
	{{ Html::style('css/fullcalendar.min.css') }} {{ Html::style('css/animate.min.css') }} {{ Html::style('css/sweetalert2.min.css') }} {{ Html::style('css/material-design-iconic-font.min.css') }} {{ Html::style('css/jquery.mCustomScrollbar.min.css') }} {{
	Html::style('css/bootstrap-select.css') }} {{ Html::style('css/nouislider.min.css') }} {{ Html::style('css/bootstrap-datetimepicker.min.css') }} @stack('styles') {{ Html::style('css/app_1.min.css') }} {{ Html::style('css/app_2.min.css') }}
...
<body>
	...
	{{ Html::script('js/jquery.min.js') }} {{ Html::script('js/bootstrap.min.js') }} {{ Html::script('js/moment.min.js') }} {{ Html::script('js/fullcalendar.min.js') }} {{ Html::script('js/waves.min.js') }} {{ Html::script('js/bootstrap-growl.min.js') }}
	{{ Html::script('js/sweetalert2.min.js') }} {{ Html::script('js/jquery.mCustomScrollbar.concat.min.js') }} {{ Html::script('js/autosize.min.js') }} {{ Html::script('js/bootstrap-select.js') }} {{ Html::script('js/nouislider.min.js') }} {{ Html::script('js/bootstrap-datetimepicker.min.js')
	}} {{ Html::script('js/typeahead.bundle.min.js') }} {{ Html::script('js/jquery.mask.min.js') }} {{ Html::script('js/jquery.maskmoney.min.js') }} {{ Html::script('js/app.min.js') }}
